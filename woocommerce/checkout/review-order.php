 ...
 *
 * Override of woocommerce/templates/checkout/review-order.php. Line items show
 * the SKU, which is how this store's customers verify an order.
 *
 * @package DaimZap
 *
 * @var bool $checkout Whether this is the checkout page.
 */
...
<table class="shop_table woocommerce-checkout-review-order-table">
	<thead>
		<tr>
			<th class="product-name"><?php esc_html_e( 'Товар', 'daimzap' ); ?></th>
			<th class="product-total"><?php esc_html_e( 'Сумма', 'daimzap' ); ?></th>
		</tr>
	</thead>
